...
export const STUDENT_TEMPLATE: CardDesign = {
  ...
  texts: [
    ...
    { id: 'st-dob', content: 'DOB: {{Date of Birth}}', x: 100, y: 108, fontSize: 9, color: '#64748b', fontWeight: 'normal', fontStyle: 'normal', textAlign: 'left' },
    { id: 'st-phone', content: 'Tel: {{Phone}}', x: 100, y: 121, fontSize: 9, color: '#64748b', fontWeight: 'normal', fontStyle: 'normal', textAlign: 'left' },
